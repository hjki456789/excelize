...
Supports saving a file without losing original charts of XLSX. This library needs Go version 1.10 or later. The full API docs can be seen using go's built-in documentation tool, or online at [go.dev](https://pkg.go.dev/github.com/hjki456789/excelize/v2?tab=doc) and [docs reference](https://xuri.me/excelize/).
